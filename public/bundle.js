...
/***/ function(module, exports, __webpack_require__) {
	...
	var Levels = __webpack_require__(159);
	var Abilities = __webpack_require__(160);
	...
	var Main = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      'div',
	      { className: 'card' },
	      React.createElement(Levels, { levels: this.state.levels }),
	      React.createElement(
	        'ul',
	        ...
	        React.createElement(Abilities, { abilities: this.state.abilities }),
	        React.createElement(
	          'div',
	          { className: 'card-text' },
	          this.state.text
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var ReactDOM = __webpack_require__(158);
	var Ability = __webpack_require__(161);
	...
	var Abilities = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      'div',
	      null,
	      React.createElement(Ability, { name: 'backend', level: backend }),
	      React.createElement(Ability, { name: 'database', level: database }),
	      React.createElement(Ability, { name: 'frontend', level: frontend }),
	      React.createElement(Ability, { name: 'design', level: design })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Ability = React.createClass({
	  ...
	  render: function render() {
	    var star = React.createElement('i', { className: 'puntuation icon icon-star' });
	    var empty = React.createElement('i', { className: 'puntuation icon icon-star-empty' });
	    var className = 'icon hability icon-' + this.props.name;
	    var level = this.props.level;
	    var stars = [1, 1, 1, 1, 1];
	    var levels = stars.map(function (_, idx) {
	      if (level > idx) {
	        return React.createElement('i', { key: idx, className: 'puntuation icon icon-star' });
	      } else {
	        return React.createElement('i', { key: idx, className: 'puntuation icon icon-star-empty' });
	      }
	    });
	    return React.createElement(
	      'li',
